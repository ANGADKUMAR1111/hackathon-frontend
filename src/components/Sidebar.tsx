...
const NavItem = styled(Link)<{ isActive?: boolean }>`
  ...
  color: ${props => props.isActive ? '#4361ee' : '#64748b'};
  text-decoration: none;
  font-size: 0.95rem;
  margin-bottom: 0.5rem;
  border-left: 3px solid ${props => props.isActive ? '#4361ee' : 'transparent'};
  background-color: ${props => props.isActive ? '#ebefff' : 'transparent'};
  transition: all 0.2s ease;
  
  &:hover {
    color: #4361ee;
    background-color: ${props => props.isActive ? '#ebefff' : '#f8fafc'};
  }
...
const Sidebar: React.FC = () => {
  ...
  return (
    <SidebarContainer>
      <NavContent>
        <NavItem to="/ai-agent" isActive={isActive('/ai-agent')}>
          <div className="icon">
        ...
        <NavItem to="/platform-setup" isActive={isActive('/platform-setup')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NavItem to="/campaigns" isActive={isActive('/campaigns')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NavItem to="/promoters" isActive={isActive('/promoters')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NavItem to="/leads" isActive={isActive('/leads')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NavItem to="/payouts" isActive={isActive('/payouts')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <BottomContent>
        ...
        <NavItem to="/help" isActive={isActive('/help')}>
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
